...
import static i5.las2peer.services.r.TestUtil.*;
...
public class RTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(R.class.getCanonicalName(),"0.1");
